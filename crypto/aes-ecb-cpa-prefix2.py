# In Prefix-2 they have the full PKCS#7 padding (on a block that's 16 bytes long, it is padded with a new block containing 16 0x10 bytes)
# In Prefix-1 they skipped this type of padding.
# The same solution actually works.
